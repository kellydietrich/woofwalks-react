...
function signAccessToken(user) {
    var payload = (0, lodash_1.omit)(user.toJSON(), user_model_1.privateFields);
    var accessToken = (0, jwt_1.signJwt)(payload, "accessTokenPrivateKey", {
        expiresIn: "15m",
    });
    return accessToken;
}
